...
use App\Context\Account\Application\UpdateAccount\UpdateAccountCommand;
use App\Context\Account\Application\UpdateAccount\UpdateAccountCommandHandler;
use App\Context\Account\Infrastructure\Http\Dto\UpdateAccountRequestDto;
use Symfony\Component\HttpFoundation\Response;
use Symfony\Component\Routing\Attribute\Route;

final readonly class AccountUpdaterPutController
{
