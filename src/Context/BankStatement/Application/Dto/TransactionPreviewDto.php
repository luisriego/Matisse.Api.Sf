...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(
            property: 'suggestedExpectedExpense',
            ref: '#/components/schemas/ExpectedExpensePreview',
            nullable: true,
        ...
        new OA\Property(
            property: 'creditClassificationSource',
            type: 'string',
            nullable: true,
        ...
        new OA\Property(
            property: 'suggestedIncomeTypeId',
            type: 'string',
            format: 'uuid',
            nullable: true,
